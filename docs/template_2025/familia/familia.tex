\addcontentsline{etoc}{chapter}{\textit{Surname1 A1.\,B1., Surname2 A2.\,B2.} Title}%эта строка нужна для формирования содержания журнала на английском языке
...
\blfootnote{\hspace{-7pt}\textcopyright \, Фамилия1 И1.\,О1., Фамилия2 И2.\,О2., 2025\\ \indent\textcopyright \, Федеральное государственное автономное образовательное учреждение высшего образования\\
...
\section{Название 1-го раздела}

Текст первого раздела.

\begin{figure}[h!] \centering
\includegraphics[height=0.32\textheight]{familia1}
\caption{Пример вставки рисунка}
\end{figure}

 

\section{Название 2-го раздела}
...
\bibitem{s3}  \textit{Лайонс Р.}  Цифровая обработка сигналов.  Москва~: Бином, 2006.  С.~361--369.
