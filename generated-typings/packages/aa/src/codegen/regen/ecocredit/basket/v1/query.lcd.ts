...
import { QueryBasketRequest, QueryBasketResponseSDKType, QueryBasketsRequest, QueryBasketsResponseSDKType, QueryBasketBalancesRequest, QueryBasketBalancesResponseSDKType, QueryBasketBalanceRequest, QueryBasketBalanceResponseSDKType } from "./query";
export class LCDQueryClient {
  ...
  async basket(params: QueryBasketRequest): Promise<QueryBasketResponseSDKType> {
    const endpoint = `regen/ecocredit/basket/v1/baskets/${params.basketDenom}`;
  ...
  async basketBalances(params: QueryBasketBalancesRequest): Promise<QueryBasketBalancesResponseSDKType> {
    ...
    const endpoint = `regen/ecocredit/basket/v1/baskets/${params.basketDenom}/balances`;
  ...
  async basketBalance(params: QueryBasketBalanceRequest): Promise<QueryBasketBalanceResponseSDKType> {
    const endpoint = `regen/ecocredit/basket/v1/baskets/${params.basketDenom}/balances/${params.batchDenom}`;
