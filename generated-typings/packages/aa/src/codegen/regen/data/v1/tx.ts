import { ContentHash, ContentHashSDKType, ContentHash_Graph, AttestorEntry, AttestorEntrySDKType } from "./types";
...
export const MsgAttestResponse = {
  ...
  fromAmino(object: MsgAttestResponseAmino): MsgAttestResponse {
    return {
      newEntries: Array.isArray(object?.new_entries) ? object.new_entries.map((e: any) => AttestorEntry.fromAmino(e)) : []
    };
  },
