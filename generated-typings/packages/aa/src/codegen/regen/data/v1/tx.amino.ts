...
export interface MsgAnchorAminoType extends AminoMsg {
...
export interface MsgAttestAminoType extends AminoMsg {
...
export interface MsgDefineResolverAminoType extends AminoMsg {
...
export interface MsgRegisterResolverAminoType extends AminoMsg {
...
export const AminoConverter = {
  "/regen.data.v1.MsgAnchor": {
    ...
    toAmino: ({
      sender,
      contentHash
    }: MsgAnchor): MsgAnchorAminoType["value"] => {
      return {
        sender,
        content_hash: {
          raw: {
    ...
    fromAmino: ({
      sender,
      content_hash
    }: MsgAnchorAminoType["value"]): MsgAnchor => {
      return {
        sender,
        contentHash: {
          raw: {
  ...
  "/regen.data.v1.MsgAttest": {
    ...
    toAmino: ({
      attestor,
      contentHashes
    }: MsgAttest): MsgAttestAminoType["value"] => {
      return {
        attestor,
    ...
    fromAmino: ({
      attestor,
      content_hashes
    }: MsgAttestAminoType["value"]): MsgAttest => {
      return {
        attestor,
  ...
  "/regen.data.v1.MsgDefineResolver": {
    ...
    toAmino: ({
      manager,
      resolverUrl
    }: MsgDefineResolver): MsgDefineResolverAminoType["value"] => {
      return {
        manager,
    ...
    fromAmino: ({
      manager,
      resolver_url
    }: MsgDefineResolverAminoType["value"]): MsgDefineResolver => {
      return {
        manager,
  ...
  "/regen.data.v1.MsgRegisterResolver": {
    ...
    toAmino: ({
      ...
      resolverId,
      contentHashes
    }: MsgRegisterResolver): MsgRegisterResolverAminoType["value"] => {
      return {
        manager,
    ...
    fromAmino: ({
      ...
      resolver_id,
      content_hashes
    }: MsgRegisterResolverAminoType["value"]): MsgRegisterResolver => {
      return {
        manager,
        resolverId: BigInt(resolver_id),
        contentHashes: content_hashes.map(el0 => ({
          raw: {
            hash: el0.raw.hash,
